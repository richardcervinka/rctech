...
namespace Rc
{
    ...
    public:
        ...
        static void OnButtonPushed(ButtonEvent::Handler& handler)
        {
            m_event_button_pushed.Add(handler);
        }

        static void OnButtonReleased(ButtonEvent::Handler& handler)
        {
            m_event_button_released.Add(handler);
        }
    ...
    private:
        ...
        inline static std::array<ButtonState, 256> m_buttons {};

        inline static ButtonEvent m_event_button_pushed;
        inline static ButtonEvent m_event_button_released;
