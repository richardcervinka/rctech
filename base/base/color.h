...
namespace Rc
{
	...
	public:
		...
		static constexpr Color Rgb8(uint8_t r, uint8_t g, uint8_t b, uint8_t a)
		{
			return {
		...
		static Color Hsv8(uint8_t h, uint8_t s, uint8_t v, uint8_t a)
		{
			return Color::Hsv(
		...
		float const* Data() const { return &r; }
	...
	inline Color operator*(float s, Color const& c)
	{
